<template>
    <div>
        ...
        <div class="navigation">
            ...
            <div class="navigatio-right" @click="show=!show" style="display:flex;align-items:center;justify-content: flex-end;">
               <svg t="1665990427850" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2912" width="22" height="22"><path d="M809.890909 879.709091H116.363636V186.181818h344.436364V116.363636H79.127273c-18.618182 0-32.581818 18.618182-32.581818 37.236364v763.345455c0 18.618182 13.963636 32.581818 32.581818 32.581818h763.345454c18.618182 0 32.581818-13.963636 32.581818-32.581818v-367.709091h-69.818181v330.472727z" p-id="2913" fill="#f03e38"></path><path d="M944.872727 74.472727h-279.272727v69.818182h200.145455l-358.4 358.4 46.545454 46.545455 358.4-358.4v176.872727H977.454545V111.709091c0-18.618182-13.963636-37.236364-32.581818-37.236364z" p-id="2914" fill="#f03e38"></path></svg>
            </div>
        </div>
        ...
        <!-- 底部导航 -->
        <div class="footh" v-show="MoviesData.comScorePersona" @click="goBuy(MoviesData.id)">特惠购票</div>
